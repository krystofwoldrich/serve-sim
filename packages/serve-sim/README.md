...
Mount the preview on your Metro dev server and access it at `http://localhost:8081/.sim`.

Customize `metro.config.js` (`bunx expo customize`) and wrap the config with `withSimServe`:
